...
public class AnySoftKeyboardGesturesTest extends AnySoftKeyboardBaseTest {
  ...
  public void testSwipeForActionNextSymbolsConfigurable() {
    ...
    mAnySoftKeyboardUnderTest.onFirstDownKey('x');
    mAnySoftKeyboardUnderTest.onSwipeRight(false);
    Assert.assertEquals(KeyCodes.MODE_SYMBOLS, mAnySoftKeyboardUnderTest.getLastOnKeyPrimaryCode());
  }
  ...
  public void testSwipeForActionCycleInModeConfigurable() {
    ...
    mAnySoftKeyboardUnderTest.onSwipeLeft(false);
    Assert.assertEquals(
        KeyCodes.KEYBOARD_CYCLE_INSIDE_MODE, mAnySoftKeyboardUnderTest.getLastOnKeyPrimaryCode());
  }
  ...
  public void testSwipeForActionCycleReverseConfigurable() {
    ...
    mAnySoftKeyboardUnderTest.onSwipeRight(false);
    Assert.assertEquals(
        KeyCodes.KEYBOARD_REVERSE_CYCLE, mAnySoftKeyboardUnderTest.getLastOnKeyPrimaryCode());
  }
  ...
  public void testSwipeForActionCompactLayoutRightConfigurable() {
    ...
    mAnySoftKeyboardUnderTest.onSwipeRight(false);
    Assert.assertEquals(
        KeyCodes.COMPACT_LAYOUT_TO_RIGHT, mAnySoftKeyboardUnderTest.getLastOnKeyPrimaryCode());
  }
  ...
  public void testSwipeForActionCompactLayoutLeftConfigurable() {
    ...
    mAnySoftKeyboardUnderTest.onSwipeRight(false);
    Assert.assertEquals(
        KeyCodes.COMPACT_LAYOUT_TO_LEFT, mAnySoftKeyboardUnderTest.getLastOnKeyPrimaryCode());
  }
