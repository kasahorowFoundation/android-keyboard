...
public class PeriodsTimeProviderTest {
    ...
    public void testHappyPath() {
        ...
        Assert.assertEquals(99 * ONE_DAY, underTest.getNextTimeOffset());
        instance.set(Calendar.DAY_OF_YEAR, 98);
        Assert.assertEquals(2 * ONE_DAY, underTest.getNextTimeOffset());
        instance.set(Calendar.DAY_OF_YEAR, 100);
        Assert.assertEquals(1 * ONE_DAY, underTest.getNextTimeOffset());
        ...
        Assert.assertEquals(85 * ONE_DAY, underTest.getNextTimeOffset());
        instance.set(Calendar.DAY_OF_YEAR, 116);
        Assert.assertEquals(84 * ONE_DAY, underTest.getNextTimeOffset());
        ...
        Assert.assertEquals((365 - 230 + 100) * ONE_DAY, underTest.getNextTimeOffset());
    }
}
