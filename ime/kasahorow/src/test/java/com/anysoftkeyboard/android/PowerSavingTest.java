...
public class PowerSavingTest {
  ...
  public void testValuesArray() {
    final String[] stringArray =
        getApplicationContext().getResources().getStringArray(R.array.power_save_mode_values);
  ...
  public static void sendBatteryState(boolean lowState) {
    ApplicationProvider.getApplicationContext()
        .sendBroadcast(
            new Intent(lowState ? Intent.ACTION_BATTERY_LOW : Intent.ACTION_BATTERY_OKAY));
