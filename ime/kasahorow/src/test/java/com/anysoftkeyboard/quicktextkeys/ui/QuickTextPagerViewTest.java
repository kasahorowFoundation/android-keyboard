...
public class QuickTextPagerViewTest {
    ...
    public void testSetOnKeyboardActionListener() throws Exception {
        ...
        ShadowView shadowView =
                Shadows.shadowOf(
                        (View) mUnderTest.findViewById(R.id.quick_keys_popup_quick_keys_settings));
    ...
    public void testPassesOnlyEnabledAddOns() throws Exception {
        ...
        quickTextKeyFactory.setAddOnEnabled(
                quickTextKeyFactory.getAllAddOns().get(0).getId(), false);
        Assert.assertEquals(17, quickTextKeyFactory.getAllAddOns().size());
        ...
        quickTextKeyFactory.setAddOnEnabled(
                quickTextKeyFactory.getAllAddOns().get(1).getId(), false);
