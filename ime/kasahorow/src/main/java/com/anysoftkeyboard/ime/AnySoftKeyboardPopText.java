...
public abstract class AnySoftKeyboardPopText extends AnySoftKeyboardPowerSaving {
  ...
  public void onCreate() {
    ...
    addDisposable(
        prefs()
            .getString(
                R.string.settings_key_pop_text_option, R.string.settings_default_pop_text_option)
            .asObservable()
            .subscribe(
                this::updatePopTextPrefs, GenericOnError.onError("settings_key_pop_text_option")));
  }
