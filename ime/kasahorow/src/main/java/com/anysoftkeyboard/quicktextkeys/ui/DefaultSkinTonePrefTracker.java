        ...
        prefs
            ...
            .subscribe(
                value -> {
                  ...
                  switch (value) {
                    case "type_2":
                      mDefaultSkinTone = JavaEmojiUtils.SkinTone.Fitzpatrick_2;
                      break;
                    case "type_3":
                      mDefaultSkinTone = JavaEmojiUtils.SkinTone.Fitzpatrick_3;
                      break;
                    case "type_4":
                      mDefaultSkinTone = JavaEmojiUtils.SkinTone.Fitzpatrick_4;
                      break;
                    case "type_5":
                      mDefaultSkinTone = JavaEmojiUtils.SkinTone.Fitzpatrick_5;
                      break;
                    case "type_6":
                      mDefaultSkinTone = JavaEmojiUtils.SkinTone.Fitzpatrick_6;
                      break;
                    case "random":
                      mRandom = true;
                      break;
