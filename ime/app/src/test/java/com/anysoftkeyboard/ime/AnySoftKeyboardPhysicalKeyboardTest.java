...
public class AnySoftKeyboardPhysicalKeyboardTest extends AnySoftKeyboardBaseTest {
  ...
  public void testDoesNotShowStatusBarIcon() {
    ...
    SharedPrefsHelper.setPrefsValue(
        getApplicationContext().getString(R.string.settings_key_keyboard_icon_in_status_bar),
        false);
  ...
  public void testHidesStatusBarIconOnPrefsChange() {
    SharedPrefsHelper.setPrefsValue(
        getApplicationContext().getString(R.string.settings_key_keyboard_icon_in_status_bar), true);
  ...
  public void testKeyboardSwitchesLayoutOnAltSpace() {
    ...
    mAnySoftKeyboardUnderTest.onKeyUp(
        KeyEvent.KEYCODE_SPACE, new TestKeyEvent(time, KeyEvent.ACTION_UP, KeyEvent.KEYCODE_SPACE));
    ...
    mAnySoftKeyboardUnderTest.onKeyDown(
        KeyEvent.KEYCODE_SPACE,
        new TestKeyEvent(time, KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_SPACE, KeyEvent.META_ALT_ON));
    mAnySoftKeyboardUnderTest.onKeyUp(
        KeyEvent.KEYCODE_SPACE,
        new TestKeyEvent(time, KeyEvent.ACTION_UP, KeyEvent.KEYCODE_SPACE, KeyEvent.META_ALT_ON));
  ...
  public void testKeyboardSwitchesLayoutOnShiftSpace() {
    ...
    mAnySoftKeyboardUnderTest.onKeyDown(
        KeyEvent.KEYCODE_SPACE,
        new TestKeyEvent(
            time, KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_SPACE, KeyEvent.META_SHIFT_ON));
    mAnySoftKeyboardUnderTest.onKeyUp(
        KeyEvent.KEYCODE_SPACE,
        new TestKeyEvent(time, KeyEvent.ACTION_UP, KeyEvent.KEYCODE_SPACE, KeyEvent.META_SHIFT_ON));
