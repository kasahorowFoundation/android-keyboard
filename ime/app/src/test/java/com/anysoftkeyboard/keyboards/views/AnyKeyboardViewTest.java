...
public class AnyKeyboardViewTest extends AnyKeyboardViewWithMiniKeyboardTest {
  ...
  public void testSlideToNextKeyHappyPath() {
    AnyKeyboard.AnyKey key1 = (AnyKeyboard.AnyKey) mEnglishKeyboard.getKeys().get(15);
    AnyKeyboard.AnyKey key2 = (AnyKeyboard.AnyKey) mEnglishKeyboard.getKeys().get(16);
  ...
  public void testDoesNotReportGestureDoneWhenTwoFingersAreUsed() {
    ...
    ViewTestUtils.navigateFromTo(
        mViewUnderTest,
        Arrays.asList(
            new ViewTestUtils.Finger(hPoint, ePoint), new ViewTestUtils.Finger(kPoint, ePoint)),
        100,
  ...
  public void testReportGestureDoneHappyPath() {
    ...
    inOrder
        ...
        .onGestureTypingInputStart(anyInt(), anyInt(), any(), anyLong());
    inOrder
        .verify(mMockKeyboardListener, Mockito.atLeastOnce())
        .onGestureTypingInput(anyInt(), anyInt(), anyLong());
  ...
  public void testQuickTextPopupHappyPath() {
    ...
    Assert.assertArrayEquals(
        provider.KEY_STATE_FUNCTIONAL_NORMAL, quickTextPopupKey.getCurrentDrawableState(provider));
  ...
  public void testWithLongPressDeleteKeyOutput() {
    ...
    Mockito.verify(mMockKeyboardListener)
        .onKey(
            captor.capture(), same(key), Mockito.anyInt(), any(int[].class), Mockito.anyBoolean());
  ...
  public void testWatermarkSetsBounds() {
    final int dimen =
        getApplicationContext().getResources().getDimensionPixelOffset(R.dimen.watermark_size);
